...
// CreateManagedContactOpts Optional parameters for the method 'CreateManagedContact'
type CreateManagedContactOpts struct {
    ManagedContact optional.Interface
}

/*
CreateManagedContact Create Managed Contact
 ...
 * @param optional nil or *CreateManagedContactOpts - Optional Parameters:
 * @param "ManagedContact" (optional.Interface of ManagedContact) -  Information about the contact to create.
@return ManagedContact
*/
func (a *ManagedApiService) CreateManagedContact(ctx _context.Context, localVarOptionals *CreateManagedContactOpts) (ManagedContact, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/managed/contacts"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ManagedContact.IsSet() {
		localVarOptionalManagedContact, localVarOptionalManagedContactok := localVarOptionals.ManagedContact.Value().(ManagedContact)
		if !localVarOptionalManagedContactok {
			return localVarReturnValue, nil, reportError("managedContact should be ManagedContact")
		}
		localVarPostBody = &localVarOptionalManagedContact
	}
...
// CreateManagedCredentialOpts Optional parameters for the method 'CreateManagedCredential'
type CreateManagedCredentialOpts struct {
    UNKNOWNBASETYPE optional.Interface
}

/*
CreateManagedCredential Create Managed Credential
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CreateManagedCredentialOpts - Optional Parameters:
 * @param "UNKNOWNBASETYPE" (optional.Interface of UNKNOWN_BASE_TYPE) -  Information about the Credential to create.
@return ManagedCredential
*/
func (a *ManagedApiService) CreateManagedCredential(ctx _context.Context, localVarOptionals *CreateManagedCredentialOpts) (ManagedCredential, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/credentials"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
// CreateManagedServiceOpts Optional parameters for the method 'CreateManagedService'
type CreateManagedServiceOpts struct {
    UNKNOWNBASETYPE optional.Interface
}

/*
CreateManagedService Create Managed Service
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CreateManagedServiceOpts - Optional Parameters:
 * @param "UNKNOWNBASETYPE" (optional.Interface of UNKNOWN_BASE_TYPE) -  Information about the service to monitor.
@return ManagedService
*/
func (a *ManagedApiService) CreateManagedService(ctx _context.Context, localVarOptionals *CreateManagedServiceOpts) (ManagedService, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/services"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
DeleteManagedContact Delete Managed Contact
Deletes a Managed Contact. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contactId The ID of the contact to access.
@return map[string]interface{}
*/
func (a *ManagedApiService) DeleteManagedContact(ctx _context.Context, contactId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/contacts/{contactId}"
...
/*
DeleteManagedCredential Delete Managed Credential
...
@return map[string]interface{}
*/
func (a *ManagedApiService) DeleteManagedCredential(ctx _context.Context, credentialId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/credentials/{credentialId}/revoke"
...
/*
DeleteManagedService Delete Managed Service
...
@return map[string]interface{}
*/
func (a *ManagedApiService) DeleteManagedService(ctx _context.Context, serviceId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/services/{serviceId}"
...
/*
DisableManagedService Disable Managed Service
Temporarily disables monitoring of a Managed Service. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serviceId The ID of the Managed Service to disable.
@return ManagedService
*/
func (a *ManagedApiService) DisableManagedService(ctx _context.Context, serviceId int32) (ManagedService, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/services/{serviceId}/disable"
	localVarPath = strings.Replace(localVarPath, "{"+"serviceId"+"}", _neturl.QueryEscape(parameterToString(serviceId, "")) , -1)
...
/*
EnableManagedService Enable Managed Service
Enables monitoring of a Managed Service. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serviceId The ID of the Managed Service to enable.
@return ManagedService
*/
func (a *ManagedApiService) EnableManagedService(ctx _context.Context, serviceId int32) (ManagedService, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/services/{serviceId}/enable"
	localVarPath = strings.Replace(localVarPath, "{"+"serviceId"+"}", _neturl.QueryEscape(parameterToString(serviceId, "")) , -1)
...
/*
GetManagedContact View Managed Contact
Returns a single Managed Contact. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contactId The ID of the contact to access.
@return ManagedContact
*/
func (a *ManagedApiService) GetManagedContact(ctx _context.Context, contactId int32) (ManagedContact, *_nethttp.Response, error) {
	var (
...
// GetManagedContactsOpts Optional parameters for the method 'GetManagedContacts'
type GetManagedContactsOpts struct {
    Page optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetManagedContactsOpts - Optional Parameters:
...
*/
func (a *ManagedApiService) GetManagedContacts(ctx _context.Context, localVarOptionals *GetManagedContactsOpts) (InlineResponse20027, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
GetManagedCredential View Managed Credential
Returns a single Managed Credential. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param credentialId The ID of the Credential to access.
@return ManagedCredential
*/
func (a *ManagedApiService) GetManagedCredential(ctx _context.Context, credentialId int32) (ManagedCredential, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/credentials/{credentialId}"
	localVarPath = strings.Replace(localVarPath, "{"+"credentialId"+"}", _neturl.QueryEscape(parameterToString(credentialId, "")) , -1)
...
// GetManagedCredentialsOpts Optional parameters for the method 'GetManagedCredentials'
type GetManagedCredentialsOpts struct {
    Page optional.Int32
    PageSize optional.Int32
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetManagedCredentialsOpts - Optional Parameters:
 * @param "Page" (optional.Int32) -  The page of a collection to return.
 * @param "PageSize" (optional.Int32) -  The number of items to return per page.
@return InlineResponse20028
*/
func (a *ManagedApiService) GetManagedCredentials(ctx _context.Context, localVarOptionals *GetManagedCredentialsOpts) (InlineResponse20028, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
GetManagedIssue View Managed Issue
Returns a single Issue that is impacting or did impact one of your Managed Services. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param issueId The Issue to look up.
@return ManagedIssue
*/
func (a *ManagedApiService) GetManagedIssue(ctx _context.Context, issueId int32) (ManagedIssue, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/issues/{issueId}"
	localVarPath = strings.Replace(localVarPath, "{"+"issueId"+"}", _neturl.QueryEscape(parameterToString(issueId, "")) , -1)
...
// GetManagedIssuesOpts Optional parameters for the method 'GetManagedIssues'
type GetManagedIssuesOpts struct {
    Page optional.Int32
    PageSize optional.Int32
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetManagedIssuesOpts - Optional Parameters:
 * @param "Page" (optional.Int32) -  The page of a collection to return.
 * @param "PageSize" (optional.Int32) -  The number of items to return per page.
@return InlineResponse20030
*/
func (a *ManagedApiService) GetManagedIssues(ctx _context.Context, localVarOptionals *GetManagedIssuesOpts) (InlineResponse20030, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/issues"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetManagedLinodeSetting View Linode's Managed Settings
Returns a single Linode&#39;s Managed settings. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param linodeId The Linode ID whose settings we are accessing.
@return ManagedLinodeSettings
*/
func (a *ManagedApiService) GetManagedLinodeSetting(ctx _context.Context, linodeId int32) (ManagedLinodeSettings, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/linode-settings/{linodeId}"
...
// GetManagedLinodeSettingsOpts Optional parameters for the method 'GetManagedLinodeSettings'
type GetManagedLinodeSettingsOpts struct {
    Page optional.Int32
    PageSize optional.Int32
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetManagedLinodeSettingsOpts - Optional Parameters:
 * @param "Page" (optional.Int32) -  The page of a collection to return.
 * @param "PageSize" (optional.Int32) -  The number of items to return per page.
@return InlineResponse20031
*/
func (a *ManagedApiService) GetManagedLinodeSettings(ctx _context.Context, localVarOptionals *GetManagedLinodeSettingsOpts) (InlineResponse20031, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/linode-settings"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetManagedService View Managed Service
Returns information about a single Managed Service on your Account. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serviceId The ID of the Managed Service to access.
@return ManagedService
*/
func (a *ManagedApiService) GetManagedService(ctx _context.Context, serviceId int32) (ManagedService, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *ManagedApiService) GetManagedServices(ctx _context.Context) (InlineResponse20032, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *ManagedApiService) GetManagedStats(ctx _context.Context) (InlineResponse20033, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/stats"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
UpdateManagedContact Update Managed Contact
Updates information about a Managed Contact. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contactId The ID of the contact to access.
 * @param managedContact The fields to update.
@return ManagedContact
*/
func (a *ManagedApiService) UpdateManagedContact(ctx _context.Context, contactId int32, managedContact ManagedContact) (ManagedContact, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &managedContact
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
/*
UpdateManagedCredential Update Managed Credential
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param credentialId The ID of the Credential to access.
 * @param managedCredential The fields to update.
@return ManagedCredential
*/
func (a *ManagedApiService) UpdateManagedCredential(ctx _context.Context, credentialId int32, managedCredential ManagedCredential) (ManagedCredential, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &managedCredential
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
// UpdateManagedCredentialUsernamePasswordOpts Optional parameters for the method 'UpdateManagedCredentialUsernamePassword'
type UpdateManagedCredentialUsernamePasswordOpts struct {
    UNKNOWNBASETYPE optional.Interface
}

/*
UpdateManagedCredentialUsernamePassword Update Managed Credential Username and Password
Updates the username and password for a Managed Credential. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param credentialId The ID of the Credential to update.
 * @param optional nil or *UpdateManagedCredentialUsernamePasswordOpts - Optional Parameters:
 * @param "UNKNOWNBASETYPE" (optional.Interface of UNKNOWN_BASE_TYPE) -  The new username and password to assign to the Managed Credential. 
@return map[string]interface{}
*/
func (a *ManagedApiService) UpdateManagedCredentialUsernamePassword(ctx _context.Context, credentialId int32, localVarOptionals *UpdateManagedCredentialUsernamePasswordOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/credentials/{credentialId}/update"
	localVarPath = strings.Replace(localVarPath, "{"+"credentialId"+"}", _neturl.QueryEscape(parameterToString(credentialId, "")) , -1)
...
/*
UpdateManagedLinodeSetting Update Linode's Managed Settings
Updates a single Linode&#39;s Managed settings. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param linodeId The Linode ID whose settings we are accessing.
 * @param managedLinodeSettings The settings to update.
@return ManagedLinodeSettings
*/
func (a *ManagedApiService) UpdateManagedLinodeSetting(ctx _context.Context, linodeId int32, managedLinodeSettings ManagedLinodeSettings) (ManagedLinodeSettings, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &managedLinodeSettings
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
/*
UpdateManagedService Update Managed Service
Updates information about a Managed Service. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param serviceId The ID of the Managed Service to access.
 * @param managedService The fields to update.
@return ManagedService
*/
func (a *ManagedApiService) UpdateManagedService(ctx _context.Context, serviceId int32, managedService ManagedService) (ManagedService, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// body params
	localVarPostBody = &managedService
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
/*
ViewManagedSSHKey View Managed SSH Key
...
*/
func (a *ManagedApiService) ViewManagedSSHKey(ctx _context.Context) (InlineResponse20029, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/managed/credentials/sshkey"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
