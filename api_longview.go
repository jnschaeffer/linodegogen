...
/*
CreateLongviewClient Create Longview Client
 ...
 * @param longviewClient Information about the LongviewClient to create.
@return LongviewClient
*/
func (a *LongviewApiService) CreateLongviewClient(ctx _context.Context, longviewClient LongviewClient) (LongviewClient, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/longview/clients"
	...
	// body params
	localVarPostBody = &longviewClient
...
/*
DeleteLongviewClient Delete Longview Client
...
*/
func (a *LongviewApiService) DeleteLongviewClient(ctx _context.Context, clientId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/longview/clients/{clientId}"
...
/*
GetLongviewClient View Longview Client
Returns a single Longview Client you can access. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clientId The Longview Client ID to access.
@return LongviewClient
*/
func (a *LongviewApiService) GetLongviewClient(ctx _context.Context, clientId int32) (LongviewClient, *_nethttp.Response, error) {
	var (
...
// GetLongviewClientsOpts Optional parameters for the method 'GetLongviewClients'
type GetLongviewClientsOpts struct {
    Page optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetLongviewClientsOpts - Optional Parameters:
...
*/
func (a *LongviewApiService) GetLongviewClients(ctx _context.Context, localVarOptionals *GetLongviewClientsOpts) (InlineResponse20025, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
GetLongviewSubscription View Longview Subscription
...
*/
func (a *LongviewApiService) GetLongviewSubscription(ctx _context.Context, subscriptionId string) (LongviewSubscription, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/longview/subscriptions/{subscriptionId}"
...
// GetLongviewSubscriptionsOpts Optional parameters for the method 'GetLongviewSubscriptions'
type GetLongviewSubscriptionsOpts struct {
    Page optional.Int32
    PageSize optional.Int32
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetLongviewSubscriptionsOpts - Optional Parameters:
 * @param "Page" (optional.Int32) -  The page of a collection to return.
 * @param "PageSize" (optional.Int32) -  The number of items to return per page.
@return InlineResponse20026
*/
func (a *LongviewApiService) GetLongviewSubscriptions(ctx _context.Context, localVarOptionals *GetLongviewSubscriptionsOpts) (InlineResponse20026, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/longview/subscriptions"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
UpdateLongviewClient Update Longview Client
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clientId The Longview Client ID to access.
 * @param longviewClient The fields to update.
@return LongviewClient
*/
func (a *LongviewApiService) UpdateLongviewClient(ctx _context.Context, clientId int32, longviewClient LongviewClient) (LongviewClient, *_nethttp.Response, error) {
	var (
