 ...
 * @param "UNKNOWNBASETYPE" (optional.Interface of UNKNOWN_BASE_TYPE) -  Information about the Image to create.
@return ImagePrivate
*/
func (a *ImagesApiService) CreateImage(ctx _context.Context, localVarOptionals *CreateImageOpts) (ImagePrivate, *_nethttp.Response, error) {
	var (
...
*/
func (a *ImagesApiService) DeleteImage(ctx _context.Context, imageId string) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
@return ImagePrivate
*/
func (a *ImagesApiService) GetImage(ctx _context.Context, imageId string) (ImagePrivate, *_nethttp.Response, error) {
	var (
...
*/
func (a *ImagesApiService) GetImages(ctx _context.Context, localVarOptionals *GetImagesOpts) (InlineResponse20011, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param imageId ID of the Image to look up.
 * @param imagePrivate The fields to update. 
@return ImagePrivate
*/
func (a *ImagesApiService) UpdateImage(ctx _context.Context, imageId string, imagePrivate ImagePrivate) (ImagePrivate, *_nethttp.Response, error) {
	var (
