...
*/
func (a *TagsApiService) DeleteTag(ctx _context.Context, label string) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/tags/{label}"
...
// GetTaggedObjectsOpts Optional parameters for the method 'GetTaggedObjects'
type GetTaggedObjectsOpts struct {
    Page optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param label
 * @param optional nil or *GetTaggedObjectsOpts - Optional Parameters:
...
@return map[string]interface{}
*/
func (a *TagsApiService) GetTaggedObjects(ctx _context.Context, label string, localVarOptionals *GetTaggedObjectsOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
*/
func (a *TagsApiService) GetTags(ctx _context.Context, localVarOptionals *GetTagsOpts) (InlineResponse20050, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
