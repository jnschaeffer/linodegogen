...
/*
GetRegion View Region
Returns a single Region. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param regionId ID of the Region to look up.
@return Region
*/
func (a *RegionsApiService) GetRegion(ctx _context.Context, regionId string) (Region, *_nethttp.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"regionId"+"}", _neturl.QueryEscape(parameterToString(regionId, "")) , -1)
...
*/
func (a *RegionsApiService) GetRegions(ctx _context.Context) (InlineResponse20047, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
