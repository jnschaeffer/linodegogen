...
*/
func (a *SupportApiService) CloseTicket(ctx _context.Context, ticketId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/support/tickets/{ticketId}/close"
...
// CreateTicketOpts Optional parameters for the method 'CreateTicket'
type CreateTicketOpts struct {
    SupportTicketRequest optional.Interface
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CreateTicketOpts - Optional Parameters:
 * @param "SupportTicketRequest" (optional.Interface of SupportTicketRequest) -  Open a Support Ticket.
@return SupportTicket
*/
func (a *SupportApiService) CreateTicket(ctx _context.Context, localVarOptionals *CreateTicketOpts) (SupportTicket, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/support/tickets"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.SupportTicketRequest.IsSet() {
		localVarOptionalSupportTicketRequest, localVarOptionalSupportTicketRequestok := localVarOptionals.SupportTicketRequest.Value().(SupportTicketRequest)
		if !localVarOptionalSupportTicketRequestok {
			return localVarReturnValue, nil, reportError("supportTicketRequest should be SupportTicketRequest")
		}
		localVarPostBody = &localVarOptionalSupportTicketRequest
	}
...
/*
CreateTicketAttachment Create Ticket Attachment
...
@return map[string]interface{}
*/
func (a *SupportApiService) CreateTicketAttachment(ctx _context.Context, ticketId int32, file string) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/support/tickets/{ticketId}/attachments"
	localVarPath = strings.Replace(localVarPath, "{"+"ticketId"+"}", _neturl.QueryEscape(parameterToString(ticketId, "")) , -1)
...
/*
CreateTicketReply Create Reply
Adds a reply to an existing Support Ticket. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ticketId The ID of the Support Ticket.
 * @param uNKNOWNBASETYPE Add a reply.
@return SupportTicketReply
*/
func (a *SupportApiService) CreateTicketReply(ctx _context.Context, ticketId int32, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (SupportTicketReply, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/support/tickets/{ticketId}/replies"
	localVarPath = strings.Replace(localVarPath, "{"+"ticketId"+"}", _neturl.QueryEscape(parameterToString(ticketId, "")) , -1)
...
/*
GetTicket View Support Ticket
Returns a Support Ticket under your Account. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ticketId The ID of the Support Ticket.
@return SupportTicket
*/
func (a *SupportApiService) GetTicket(ctx _context.Context, ticketId int32) (SupportTicket, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/support/tickets/{ticketId}"
	localVarPath = strings.Replace(localVarPath, "{"+"ticketId"+"}", _neturl.QueryEscape(parameterToString(ticketId, "")) , -1)
...
// GetTicketRepliesOpts Optional parameters for the method 'GetTicketReplies'
type GetTicketRepliesOpts struct {
    Page optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param ticketId The ID of the Support Ticket.
 * @param optional nil or *GetTicketRepliesOpts - Optional Parameters:
...
*/
func (a *SupportApiService) GetTicketReplies(ctx _context.Context, ticketId int32, localVarOptionals *GetTicketRepliesOpts) (InlineResponse20049, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// GetTicketsOpts Optional parameters for the method 'GetTickets'
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetTicketsOpts - Optional Parameters:
 * @param "Page" (optional.Int32) -  The page of a collection to return.
 * @param "PageSize" (optional.Int32) -  The number of items to return per page.
@return InlineResponse20048
*/
func (a *SupportApiService) GetTickets(ctx _context.Context, localVarOptionals *GetTicketsOpts) (InlineResponse20048, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
