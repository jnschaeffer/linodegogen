...
// CreateLKEClusterOpts Optional parameters for the method 'CreateLKECluster'
type CreateLKEClusterOpts struct {
    UNKNOWNBASETYPE optional.Interface
}

/*
CreateLKECluster Create Kubernetes Cluster
 ...
 * @param optional nil or *CreateLKEClusterOpts - Optional Parameters:
 * @param "UNKNOWNBASETYPE" (optional.Interface of UNKNOWN_BASE_TYPE) -  Configuration for the Kubernetes cluster
@return LkeCluster
*/
func (a *LinodeKubernetesEngineLKEApiService) CreateLKECluster(ctx _context.Context, localVarOptionals *CreateLKEClusterOpts) (LkeCluster, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/lke/clusters"
...
/*
DeleteLKECluster Delete Kubernetes Cluster
...
*/
func (a *LinodeKubernetesEngineLKEApiService) DeleteLKECluster(ctx _context.Context, clusterId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/lke/clusters/{clusterId}"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", _neturl.QueryEscape(parameterToString(clusterId, "")) , -1)
...
/*
DeleteLKENodePool Delete Node Pool
...
@return map[string]interface{}
*/
func (a *LinodeKubernetesEngineLKEApiService) DeleteLKENodePool(ctx _context.Context, clusterId int32, poolId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/lke/clusters/{clusterId}/pools/{poolId}"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", _neturl.QueryEscape(parameterToString(clusterId, "")) , -1)
...
/*
GetLKECluster View Kubernetes Cluster
Get a specific Cluster by ID.  **Beta**: This endpoint is in private beta. Please make sure to prepend all requests with &#x60;/v4beta&#x60; instead of &#x60;/v4&#x60;, and be aware that this endpoint may receive breaking updates in the future. This notice will be removed when this endpoint is out of beta. Sign up for the beta [here](https://welcome.linode.com/lkebeta/). 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clusterId ID of the Kubernetes cluster to look up.
@return LkeCluster
*/
func (a *LinodeKubernetesEngineLKEApiService) GetLKECluster(ctx _context.Context, clusterId int32) (LkeCluster, *_nethttp.Response, error) {
	var (
...
/*
GetLKEClusterAPIEndpoint View Kubernetes API Endpoint
Get the Kubernetes API server endpoint for this cluster.  **Beta**: This endpoint is in private beta. Please make sure to prepend all requests with &#x60;/v4beta&#x60; instead of &#x60;/v4&#x60;, and be aware that this endpoint may receive breaking updates in the future. This notice will be removed when this endpoint is out of beta. Sign up for the beta [here](https://welcome.linode.com/lkebeta/). 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clusterId ID of the Kubernetes cluster to look up.
@return InlineResponse20022
*/
func (a *LinodeKubernetesEngineLKEApiService) GetLKEClusterAPIEndpoint(ctx _context.Context, clusterId int32) (InlineResponse20022, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/lke/clusters/{clusterId}/api-endpoint"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", _neturl.QueryEscape(parameterToString(clusterId, "")) , -1)
...
/*
GetLKEClusterKubeconfig View Kubeconfig
Get the Kubeconfig file for a Cluster.  **Beta**: This endpoint is in private beta. Please make sure to prepend all requests with &#x60;/v4beta&#x60; instead of &#x60;/v4&#x60;, and be aware that this endpoint may receive breaking updates in the future. This notice will be removed when this endpoint is out of beta. Sign up for the beta [here](https://welcome.linode.com/lkebeta/). 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clusterId ID of the Kubernetes cluster to look up.
@return InlineResponse20023
*/
func (a *LinodeKubernetesEngineLKEApiService) GetLKEClusterKubeconfig(ctx _context.Context, clusterId int32) (InlineResponse20023, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/lke/clusters/{clusterId}/kubeconfig"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", _neturl.QueryEscape(parameterToString(clusterId, "")) , -1)
...
*/
func (a *LinodeKubernetesEngineLKEApiService) GetLKEClusterPools(ctx _context.Context, clusterId int32) (InlineResponse20021, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/lke/clusters/{clusterId}/pools"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", _neturl.QueryEscape(parameterToString(clusterId, "")) , -1)
...
*/
func (a *LinodeKubernetesEngineLKEApiService) GetLKEClusters(ctx _context.Context) (InlineResponse20020, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return LkeNodePool
*/
func (a *LinodeKubernetesEngineLKEApiService) GetLKENodePool(ctx _context.Context, clusterId int32, poolId int32) (LkeNodePool, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  LkeNodePool
	)
...
/*
GetLKEVersion View Kubernetes Version
View a Kubernetes version available for deployment to a Kubernetes cluster.  **Beta**: This endpoint is in private beta. Please make sure to prepend all requests with &#x60;/v4beta&#x60; instead of &#x60;/v4&#x60;, and be aware that this endpoint may receive breaking updates in the future. This notice will be removed when this endpoint is out of beta. Sign up for the beta [here](https://welcome.linode.com/lkebeta/). 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param version The LKE version to view.
@return LkeVersion
*/
func (a *LinodeKubernetesEngineLKEApiService) GetLKEVersion(ctx _context.Context, version string) (LkeVersion, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/lke/versions/{version}"
...
*/
func (a *LinodeKubernetesEngineLKEApiService) GetLKEVersions(ctx _context.Context) (InlineResponse20024, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/lke/versions"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
PostLKEClusterPools Create Node Pool
Creates a new Node Pool for the designated Kubernetes cluster.  **Beta**: This endpoint is in private beta. Please make sure to prepend all requests with &#x60;/v4beta&#x60; instead of &#x60;/v4&#x60;, and be aware that this endpoint may receive breaking updates in the future. This notice will be removed when this endpoint is out of beta. Sign up for the beta [here](https://welcome.linode.com/lkebeta/). 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clusterId ID of the Kubernetes cluster to look up.
 * @param uNKNOWNBASETYPE Configuration for the Node Pool
@return LkeNodePool
*/
func (a *LinodeKubernetesEngineLKEApiService) PostLKEClusterPools(ctx _context.Context, clusterId int32, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (LkeNodePool, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
// PutLKEClusterOpts Optional parameters for the method 'PutLKECluster'
type PutLKEClusterOpts struct {
    UNKNOWNBASETYPE optional.Interface
}

/*
PutLKECluster Update Kubernetes Cluster
Updates a Kubernetes cluster.  **Beta**: This endpoint is in private beta. Please make sure to prepend all requests with &#x60;/v4beta&#x60; instead of &#x60;/v4&#x60;, and be aware that this endpoint may receive breaking updates in the future. This notice will be removed when this endpoint is out of beta. Sign up for the beta [here](https://welcome.linode.com/lkebeta/). 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clusterId ID of the Kubernetes cluster to look up.
 * @param optional nil or *PutLKEClusterOpts - Optional Parameters:
 * @param "UNKNOWNBASETYPE" (optional.Interface of UNKNOWN_BASE_TYPE) -  The fields to update the Kubernetes cluster.
@return LkeCluster
*/
func (a *LinodeKubernetesEngineLKEApiService) PutLKECluster(ctx _context.Context, clusterId int32, localVarOptionals *PutLKEClusterOpts) (LkeCluster, *_nethttp.Response, error) {
	var (
...
// PutLKENodePoolOpts Optional parameters for the method 'PutLKENodePool'
type PutLKENodePoolOpts struct {
    UNKNOWNBASETYPE optional.Interface
}

/*
PutLKENodePool Update Node Pool
Updates a Node Pool. When a Node Pool&#39;s count are changed, the nodes in that pool will be replaced in a rolling fashion.  **Beta**: This endpoint is in private beta. Please make sure to prepend all requests with &#x60;/v4beta&#x60; instead of &#x60;/v4&#x60;, and be aware that this endpoint may receive breaking updates in the future. This notice will be removed when this endpoint is out of beta. Sign up for the beta [here](https://welcome.linode.com/lkebeta/). 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clusterId ID of the Kubernetes cluster to look up.
 * @param poolId ID of the Pool to look up
 * @param optional nil or *PutLKENodePoolOpts - Optional Parameters:
 * @param "UNKNOWNBASETYPE" (optional.Interface of UNKNOWN_BASE_TYPE) -  The fields to update
@return LkeNodePool
*/
func (a *LinodeKubernetesEngineLKEApiService) PutLKENodePool(ctx _context.Context, clusterId int32, poolId int32, localVarOptionals *PutLKENodePoolOpts) (LkeNodePool, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
