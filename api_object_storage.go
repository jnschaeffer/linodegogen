...
/*
CancelObjectStorage Cancel Object Storage
...
*/
func (a *ObjectStorageApiService) CancelObjectStorage(ctx _context.Context) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/object-storage/cancel"
...
// CreateObjectStorageBucketOpts Optional parameters for the method 'CreateObjectStorageBucket'
type CreateObjectStorageBucketOpts struct {
    InlineObject9 optional.Interface
}

/*
CreateObjectStorageBucket Create Object Storage Bucket
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CreateObjectStorageBucketOpts - Optional Parameters:
 * @param "InlineObject9" (optional.Interface of InlineObject9) - 
@return ObjectStorageBucket
*/
func (a *ObjectStorageApiService) CreateObjectStorageBucket(ctx _context.Context, localVarOptionals *CreateObjectStorageBucketOpts) (ObjectStorageBucket, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/object-storage/buckets"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
// CreateObjectStorageKeysOpts Optional parameters for the method 'CreateObjectStorageKeys'
type CreateObjectStorageKeysOpts struct {
    InlineObject10 optional.Interface
}

/*
CreateObjectStorageKeys Create an Object Storage Key
Provisions a new Object Storage Key on your account. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CreateObjectStorageKeysOpts - Optional Parameters:
 * @param "InlineObject10" (optional.Interface of InlineObject10) - 
@return ObjectStorageKey
*/
func (a *ObjectStorageApiService) CreateObjectStorageKeys(ctx _context.Context, localVarOptionals *CreateObjectStorageKeysOpts) (ObjectStorageKey, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/object-storage/keys"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
// CreateObjectStorageObjectURLOpts Optional parameters for the method 'CreateObjectStorageObjectURL'
type CreateObjectStorageObjectURLOpts struct {
    UNKNOWNBASETYPE optional.Interface
}

/*
CreateObjectStorageObjectURL Create Object Storage Object URL
 ...
 * @param optional nil or *CreateObjectStorageObjectURLOpts - Optional Parameters:
 * @param "UNKNOWNBASETYPE" (optional.Interface of UNKNOWN_BASE_TYPE) -  Information about the request to sign.
@return map[string]interface{}
*/
func (a *ObjectStorageApiService) CreateObjectStorageObjectURL(ctx _context.Context, clusterId string, bucket string, localVarOptionals *CreateObjectStorageObjectURLOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/object-storage/buckets/{clusterId}/{bucket}/object-url"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", _neturl.QueryEscape(parameterToString(clusterId, "")) , -1)

	localVarPath = strings.Replace(localVarPath, "{"+"bucket"+"}", _neturl.QueryEscape(parameterToString(bucket, "")) , -1)
...
/*
DeleteObjectStorageBucket Remove Object Storage Bucket
...
@return map[string]interface{}
*/
func (a *ObjectStorageApiService) DeleteObjectStorageBucket(ctx _context.Context, clusterId string, bucket string) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/object-storage/buckets/{clusterId}/{bucket}"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", _neturl.QueryEscape(parameterToString(clusterId, "")) , -1)
...
/*
DeleteObjectStorageKey Revoke Object Storage Key
Revokes an Object Storage Key.  This keypair will no longer be usable by third-party clients. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param keyId The key to look up.
@return map[string]interface{}
*/
func (a *ObjectStorageApiService) DeleteObjectStorageKey(ctx _context.Context, keyId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/object-storage/keys/{keyId}"
...
/*
GetObjectStorageBucket View Object Storage Bucket
...
@return ObjectStorageBucket
*/
func (a *ObjectStorageApiService) GetObjectStorageBucket(ctx _context.Context, clusterId string, bucket string) (ObjectStorageBucket, *_nethttp.Response, error) {
	var (
...
// GetObjectStorageBucketContentOpts Optional parameters for the method 'GetObjectStorageBucketContent'
type GetObjectStorageBucketContentOpts struct {
 ...
 * @param clusterId The ID of the cluster this bucket exists in.
 * @param bucket The bucket name.
 * @param optional nil or *GetObjectStorageBucketContentOpts - Optional Parameters:
 * @param "Marker" (optional.String) -  The \"marker\" for this request, which can be used to paginate through large buckets. Its value should be the value of the `next_marker` property returned with the last page. Listing bucket contents *does not* support arbitrary page access. See the `next_marker` property in the responses section for more details. 
 ...
 * @param "Prefix" (optional.String) -  Filters objects returned to only those whose name start with the given prefix. Commonly used in conjunction with `delimiter` to allow transversal of bucket contents in a manner similar to a filesystem. 
 * @param "PageSize" (optional.Int32) -  The number of items to return per page.
@return map[string]interface{}
*/
func (a *ObjectStorageApiService) GetObjectStorageBucketContent(ctx _context.Context, clusterId string, bucket string, localVarOptionals *GetObjectStorageBucketContentOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/object-storage/buckets/{clusterId}/{bucket}/object-list"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", _neturl.QueryEscape(parameterToString(clusterId, "")) , -1)
	...
	if localVarOptionals != nil && localVarOptionals.Delimiter.IsSet() {
		localVarQueryParams.Add("delimiter", parameterToString(localVarOptionals.Delimiter.Value(), ""))
	}
...
/*
GetObjectStorageBucketinCluster List Object Storage Buckets in Cluster
...
*/
func (a *ObjectStorageApiService) GetObjectStorageBucketinCluster(ctx _context.Context, clusterId string) (InlineResponse20040, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/object-storage/buckets/{clusterId}"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", _neturl.QueryEscape(parameterToString(clusterId, "")) , -1)
...
@return InlineResponse20040
*/
func (a *ObjectStorageApiService) GetObjectStorageBuckets(ctx _context.Context) (InlineResponse20040, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
GetObjectStorageCluster View Cluster
Returns a single Object Storage Cluster. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param clusterId The ID of the Cluster.
@return ObjectStorageCluster
*/
func (a *ObjectStorageApiService) GetObjectStorageCluster(ctx _context.Context, clusterId string) (ObjectStorageCluster, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/object-storage/clusters/{clusterId}"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", _neturl.QueryEscape(parameterToString(clusterId, "")) , -1)
...
*/
func (a *ObjectStorageApiService) GetObjectStorageClusters(ctx _context.Context) (InlineResponse20041, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/object-storage/clusters"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetObjectStorageKey View Object Storage Key
Returns a single Object Storage Key provisioned for your account. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param keyId The key to look up.
@return ObjectStorageKey
*/
func (a *ObjectStorageApiService) GetObjectStorageKey(ctx _context.Context, keyId int32) (ObjectStorageKey, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *ObjectStorageApiService) GetObjectStorageKeys(ctx _context.Context) (InlineResponse20042, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// ModifyObjectStorageBucketAccessOpts Optional parameters for the method 'ModifyObjectStorageBucketAccess'
type ModifyObjectStorageBucketAccessOpts struct {
    UNKNOWNBASETYPE optional.Interface
}

/*
ModifyObjectStorageBucketAccess Modify Object Storage Bucket Access
 ...
 * @param clusterId The ID of the cluster this bucket exists in.
 * @param bucket The bucket name.
 * @param optional nil or *ModifyObjectStorageBucketAccessOpts - Optional Parameters:
 * @param "UNKNOWNBASETYPE" (optional.Interface of UNKNOWN_BASE_TYPE) -  The changes to make to the bucket's access controls.
@return map[string]interface{}
*/
func (a *ObjectStorageApiService) ModifyObjectStorageBucketAccess(ctx _context.Context, clusterId string, bucket string, localVarOptionals *ModifyObjectStorageBucketAccessOpts) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/object-storage/buckets/{clusterId}/{bucket}/access"
	localVarPath = strings.Replace(localVarPath, "{"+"clusterId"+"}", _neturl.QueryEscape(parameterToString(clusterId, "")) , -1)
...
// UpdateObjectStorageKeyOpts Optional parameters for the method 'UpdateObjectStorageKey'
type UpdateObjectStorageKeyOpts struct {
    ObjectStorageKey optional.Interface
}

/*
UpdateObjectStorageKey Update an Object Storage Key
Updates an Object Storage Key on your account. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param keyId The key to look up.
 * @param optional nil or *UpdateObjectStorageKeyOpts - Optional Parameters:
 * @param "ObjectStorageKey" (optional.Interface of ObjectStorageKey) -  The fields to update.
@return ObjectStorageKey
*/
func (a *ObjectStorageApiService) UpdateObjectStorageKey(ctx _context.Context, keyId int32, localVarOptionals *UpdateObjectStorageKeyOpts) (ObjectStorageKey, *_nethttp.Response, error) {
	var (
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ObjectStorageKey.IsSet() {
		localVarOptionalObjectStorageKey, localVarOptionalObjectStorageKeyok := localVarOptionals.ObjectStorageKey.Value().(ObjectStorageKey)
		if !localVarOptionalObjectStorageKeyok {
			return localVarReturnValue, nil, reportError("objectStorageKey should be ObjectStorageKey")
		}
		localVarPostBody = &localVarOptionalObjectStorageKey
	}
