...
@return LinodeType
*/
func (a *LinodeTypesApiService) GetLinodeType(ctx _context.Context, typeId string) (LinodeType, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/linode/types/{typeId}"
...
*/
func (a *LinodeTypesApiService) GetLinodeTypes(ctx _context.Context) (InlineResponse20019, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/linode/types"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
