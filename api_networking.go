 ...
 * @param uNKNOWNBASETYPE Information about the address you are creating.
@return IpAddress
*/
func (a *NetworkingApiService) AllocateIP(ctx _context.Context, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (IpAddress, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/networking/ips"
...
/*
AssignIPs Assign IPs to Linodes
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param uNKNOWNBASETYPE Information about what IPv4 address to assign, and to which Linode. 
@return map[string]interface{}
*/
func (a *NetworkingApiService) AssignIPs(ctx _context.Context, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/networking/ipv4/assign"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetIP View IP Address
Returns information about a single IP Address on your Account. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param address The address to operate on.
@return IpAddress
*/
func (a *NetworkingApiService) GetIP(ctx _context.Context, address string) (IpAddress, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/networking/ips/{address}"
...
*/
func (a *NetworkingApiService) GetIPs(ctx _context.Context) (InlineResponse20034, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// GetIPv6PoolsOpts Optional parameters for the method 'GetIPv6Pools'
type GetIPv6PoolsOpts struct {
    Page optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetIPv6PoolsOpts - Optional Parameters:
...
*/
func (a *NetworkingApiService) GetIPv6Pools(ctx _context.Context, localVarOptionals *GetIPv6PoolsOpts) (InlineResponse20035, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/networking/ipv6/pools"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
// GetIPv6RangesOpts Optional parameters for the method 'GetIPv6Ranges'
type GetIPv6RangesOpts struct {
    Page optional.Int32
    PageSize optional.Int32
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetIPv6RangesOpts - Optional Parameters:
 * @param "Page" (optional.Int32) -  The page of a collection to return.
 * @param "PageSize" (optional.Int32) -  The number of items to return per page.
@return InlineResponse20036
*/
func (a *NetworkingApiService) GetIPv6Ranges(ctx _context.Context, localVarOptionals *GetIPv6RangesOpts) (InlineResponse20036, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/networking/ipv6/ranges"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param uNKNOWNBASETYPE Information about what IPs to share with which Linode.
@return map[string]interface{}
*/
func (a *NetworkingApiService) ShareIPs(ctx _context.Context, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/networking/ipv4/share"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
UpdateIP Update IP Address RDNS
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param address The address to operate on.
 * @param ipAddress The information to update.
@return IpAddress
*/
func (a *NetworkingApiService) UpdateIP(ctx _context.Context, address string, ipAddress IpAddress) (IpAddress, *_nethttp.Response, error) {
	var (
