...
/*
AddStackScript Create StackScript
Creates a StackScript in your Account. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param uNKNOWNBASETYPE The properties to set for the new StackScript.
@return StackScript
*/
func (a *StackScriptsApiService) AddStackScript(ctx _context.Context, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (StackScript, *_nethttp.Response, error) {
	var (
...
/*
DeleteStackScript Delete StackScript
Deletes a private StackScript you have permission to &#x60;read_write&#x60;. You cannot delete a public StackScript. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param stackscriptId The ID of the StackScript to look up.
@return map[string]interface{}
*/
func (a *StackScriptsApiService) DeleteStackScript(ctx _context.Context, stackscriptId string) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"stackscriptId"+"}", _neturl.QueryEscape(parameterToString(stackscriptId, "")) , -1)
...
/*
GetStackScript View StackScript
Returns all of the information about a specified StackScript, including the contents of the script. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param stackscriptId The ID of the StackScript to look up.
@return StackScript
*/
func (a *StackScriptsApiService) GetStackScript(ctx _context.Context, stackscriptId string) (StackScript, *_nethttp.Response, error) {
	var (
...
// GetStackScriptsOpts Optional parameters for the method 'GetStackScripts'
...
*/
func (a *StackScriptsApiService) GetStackScripts(ctx _context.Context, localVarOptionals *GetStackScriptsOpts) (InlineResponse20018, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// UpdateStackScriptOpts Optional parameters for the method 'UpdateStackScript'
type UpdateStackScriptOpts struct {
    StackScript optional.Interface
}

/*
UpdateStackScript Update StackScript
...
@return StackScript
*/
func (a *StackScriptsApiService) UpdateStackScript(ctx _context.Context, stackscriptId string, localVarOptionals *UpdateStackScriptOpts) (StackScript, *_nethttp.Response, error) {
	var (
