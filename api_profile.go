...
// AddSSHKeyOpts Optional parameters for the method 'AddSSHKey'
type AddSSHKeyOpts struct {
    SshKeyRequest optional.Interface
}
 ...
 * @param optional nil or *AddSSHKeyOpts - Optional Parameters:
 * @param "SshKeyRequest" (optional.Interface of SshKeyRequest) -  Add SSH Key
@return SshKey
*/
func (a *ProfileApiService) AddSSHKey(ctx _context.Context, localVarOptionals *AddSSHKeyOpts) (SshKey, *_nethttp.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/profile/sshkeys"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.SshKeyRequest.IsSet() {
		localVarOptionalSshKeyRequest, localVarOptionalSshKeyRequestok := localVarOptionals.SshKeyRequest.Value().(SshKeyRequest)
		if !localVarOptionalSshKeyRequestok {
			return localVarReturnValue, nil, reportError("sshKeyRequest should be SshKeyRequest")
		}
		localVarPostBody = &localVarOptionalSshKeyRequest
	}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param uNKNOWNBASETYPE Information about the requested token.
@return PersonalAccessToken
*/
func (a *ProfileApiService) CreatePersonalAccessToken(ctx _context.Context, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (PersonalAccessToken, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/profile/tokens"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
DeletePersonalAccessToken Revoke Personal Access Token
Revokes a Personal Access Token. The token will be invalidated immediately, and requests using that token will fail with a 401. It is possible to revoke access to the token making the request to revoke a token, but keep in mind that doing so could lose you access to the api and require you to create a new token through some other means. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tokenId The ID of the token to access.
@return map[string]interface{}
*/
func (a *ProfileApiService) DeletePersonalAccessToken(ctx _context.Context, tokenId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/profile/tokens/{tokenId}"
...
@return map[string]interface{}
*/
func (a *ProfileApiService) DeleteProfileApp(ctx _context.Context, appId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/profile/apps/{appId}"
...
@return map[string]interface{}
*/
func (a *ProfileApiService) DeleteSSHKey(ctx _context.Context, sshKeyId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/profile/sshkeys/{sshKeyId}"
...
*/
func (a *ProfileApiService) GetDevices(ctx _context.Context) (InlineResponse20045, *_nethttp.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/profile/devices"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetPersonalAccessToken View Personal Access Token
Returns a single Personal Access Token. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tokenId The ID of the token to access.
@return PersonalAccessToken
*/
func (a *ProfileApiService) GetPersonalAccessToken(ctx _context.Context, tokenId int32) (PersonalAccessToken, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
*/
func (a *ProfileApiService) GetPersonalAccessTokens(ctx _context.Context) (InlineResponse20044, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return Profile
*/
func (a *ProfileApiService) GetProfile(ctx _context.Context) (Profile, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
GetProfileApp View Authorized App
Returns information about a single app you&#39;ve authorized to access your Account. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param appId The authorized app ID to manage.
@return AuthorizedApp
*/
func (a *ProfileApiService) GetProfileApp(ctx _context.Context, appId int32) (AuthorizedApp, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// GetProfileAppsOpts Optional parameters for the method 'GetProfileApps'
type GetProfileAppsOpts struct {
    Page optional.Int32
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetProfileAppsOpts - Optional Parameters:
...
*/
func (a *ProfileApiService) GetProfileApps(ctx _context.Context, localVarOptionals *GetProfileAppsOpts) (InlineResponse20043, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/profile/apps"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
*/
func (a *ProfileApiService) GetProfileGrants(ctx _context.Context) (GrantsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/profile/grants"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetSSHKey View SSH Key
Returns a single SSH Key object identified by &#x60;id&#x60; that you have access to view. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param sshKeyId The ID of the SSHKey
@return SshKey
*/
func (a *ProfileApiService) GetSSHKey(ctx _context.Context, sshKeyId int32) (SshKey, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// GetSSHKeysOpts Optional parameters for the method 'GetSSHKeys'
type GetSSHKeysOpts struct {
    Page optional.Int32
    PageSize optional.Int32
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetSSHKeysOpts - Optional Parameters:
 * @param "Page" (optional.Int32) -  The page of a collection to return.
 * @param "PageSize" (optional.Int32) -  The number of items to return per page.
@return InlineResponse20046
*/
func (a *ProfileApiService) GetSSHKeys(ctx _context.Context, localVarOptionals *GetSSHKeysOpts) (InlineResponse20046, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
GetTrustedDevice View Trusted Device
Returns a single active TrustedDevice for your User. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param deviceId The ID of the TrustedDevice
@return TrustedDevice
*/
func (a *ProfileApiService) GetTrustedDevice(ctx _context.Context, deviceId int32) (TrustedDevice, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/profile/devices/{deviceId}"
...
/*
GetUserPreferences View User Preferences
...
@return map[string]interface{}
*/
func (a *ProfileApiService) GetUserPreferences(ctx _context.Context) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/profile/preferences"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
@return map[string]interface{}
*/
func (a *ProfileApiService) RevokeTrustedDevice(ctx _context.Context, deviceId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
TfaConfirm Confirm/Enable Two Factor Authentication
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param uNKNOWNBASETYPE The Two Factor code you generated with your Two Factor secret.
@return map[string]interface{}
*/
func (a *ProfileApiService) TfaConfirm(ctx _context.Context, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/profile/tfa-enable-confirm"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
TfaDisable Disable Two Factor Authentication
...
@return map[string]interface{}
*/
func (a *ProfileApiService) TfaDisable(ctx _context.Context) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/profile/tfa-disable"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
TfaEnable Create Two Factor Secret
...
@return map[string]interface{}
*/
func (a *ProfileApiService) TfaEnable(ctx _context.Context) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/profile/tfa-enable"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param tokenId The ID of the token to access.
 * @param personalAccessToken The fields to update.
@return PersonalAccessToken
*/
func (a *ProfileApiService) UpdatePersonalAccessToken(ctx _context.Context, tokenId int32, personalAccessToken PersonalAccessToken) (PersonalAccessToken, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &personalAccessToken
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param profile The fields to update.
@return Profile
*/
func (a *ProfileApiService) UpdateProfile(ctx _context.Context, profile Profile) (Profile, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param sshKeyId The ID of the SSHKey
 * @param sshKey The fields to update. 
@return SshKey
*/
func (a *ProfileApiService) UpdateSSHKey(ctx _context.Context, sshKeyId int32, sshKey SshKey) (SshKey, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return map[string]interface{}
*/
func (a *ProfileApiService) UpdateUserPreferences(ctx _context.Context, body map[string]interface{}) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPut
		localVarPostBody     interface{}
		localVarFormFileName string
