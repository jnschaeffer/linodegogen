...
@return Volume
*/
func (a *VolumesApiService) AttachVolume(ctx _context.Context, volumeId int32, inlineObject13 InlineObject13) (Volume, *_nethttp.Response, error) {
	var (
...
*/
func (a *VolumesApiService) CloneVolume(ctx _context.Context, volumeId int32, inlineObject14 InlineObject14) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/volumes/{volumeId}/clone"
	localVarPath = strings.Replace(localVarPath, "{"+"volumeId"+"}", _neturl.QueryEscape(parameterToString(volumeId, "")) , -1)
...
@return Volume
*/
func (a *VolumesApiService) CreateVolume(ctx _context.Context, inlineObject12 InlineObject12) (Volume, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return map[string]interface{}
*/
func (a *VolumesApiService) DeleteVolume(ctx _context.Context, volumeId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
...
@return map[string]interface{}
*/
func (a *VolumesApiService) DetachVolume(ctx _context.Context, volumeId int32) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
...
// GetVolumeOpts Optional parameters for the method 'GetVolume'
...
/*
GetVolume View Volume
Get information about a single Volume. 
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param volumeId ID of the Volume to look up.
 * @param optional nil or *GetVolumeOpts - Optional Parameters:
...
@return Volume
*/
func (a *VolumesApiService) GetVolume(ctx _context.Context, volumeId int32, localVarOptionals *GetVolumeOpts) (Volume, *_nethttp.Response, error) {
	var (
...
*/
func (a *VolumesApiService) GetVolumes(ctx _context.Context, localVarOptionals *GetVolumesOpts) (InlineResponse20017, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return map[string]interface{}
*/
func (a *VolumesApiService) ResizeVolume(ctx _context.Context, volumeId int32, inlineObject15 InlineObject15) (map[string]interface{}, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/volumes/{volumeId}/resize"
	localVarPath = strings.Replace(localVarPath, "{"+"volumeId"+"}", _neturl.QueryEscape(parameterToString(volumeId, "")) , -1)
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param volumeId ID of the Volume to look up.
 * @param uNKNOWNBASETYPE If any updated field fails to pass validation, the Volume will not be updated. 
@return Volume
*/
func (a *VolumesApiService) UpdateVolume(ctx _context.Context, volumeId int32, uNKNOWNBASETYPE UNKNOWN_BASE_TYPE) (Volume, *_nethttp.Response, error) {
	var (
